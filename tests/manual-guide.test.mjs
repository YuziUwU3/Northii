...
assert.doesNotMatch(account, /aiRechargeCards|aiOpenRecharge|aiCreatePurchase|aiOpenPurchaseClaim|aiSubmitPurchaseClaim|支付宝收款码|微信支付收款码/);
